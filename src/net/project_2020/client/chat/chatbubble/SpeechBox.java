...
public class SpeechBox extends HBox{
    private Color DEFAULT_SENDER_COLOR = Color.web("#FC1681");
    private Color DEFAULT_RECEIVER_COLOR = Color.web("#0086ff");
    ...
    public SpeechBox(String username, String message, SpeechDirection direction){
    ...
    private void configureForReceiver(){
        ...
        t.setFont(Font.font("System", FontWeight.BOLD, FontPosture.ITALIC, Font.getDefault().getSize()));
        t.setFill(Color.web("#C8A6FF"));
        displayedText.setGraphic(
                new TextFlow(
                        t, new Text("\n"), new Text(message)
                )
        );
